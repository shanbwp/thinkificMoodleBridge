        ...
        <div class="table-responsive">
          <form action="{{route('project-update',['id'=>$data->id])}}" method="post" enctype='multipart/form-data'>
            ...
            <div class="form-group">
              ...
              <input type="text" name="duration_limt" value="{{$data->duration_limt}}" class="form-control" id="duration_limt">
            </div> 
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea name="detail" class="form-control ckeditor" id="detail"> {{$data->detail}}</textarea> 
            </div>  
