...
<div class="row">
    <div class="col-md-12">
        <h4 class="card-title" style="border-bottom-style: solid">Contract </h4>
    </div> 
</div>
<div class="row">
    <div class="col-md-12">
                ...
                <div class="row"> 
                    <div class="col-md-9 text-left">
                     ...
                     <div class="col-md-3 text-center">
                        <a href="{{route('user-contract-create')}}"> <button type="button" class="btn btn-success" style="border-radius: 1.5rem" >Add New</button>  </a>
                     </div>
                </div> 
            </div>
            <div class="card-body">
